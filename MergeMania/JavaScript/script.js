...
function slideTiles(cells) {
  //handles the sliding of tiles in the specified cells array.
  return Promise.all(
    cells.flatMap((group) => {
      // maps each element of the array to a new array of promises.
...
function tile_Move(cells) {
  //checks if there is any group of cells that contains at least one tile that can be moved
